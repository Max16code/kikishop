...
// export default async function blazerPage() {
//   await connectToDatabase();
//   const blazer = await Product.find({ category: 'blazer' }).lean();

//   return (
//     <div className="p-4">
//       <h1 className="text-2xl font-bold">Blazers</h1>
...
export default async function blazerPage() {
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">blazer</h1>
